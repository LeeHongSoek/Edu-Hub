    ...
    <div class="modal-content" @click.stop>
      ...
      <form @submit.prevent="handleUpdate" class="form">
        ...
        <div class="field">
          ...
          <input v-model="editPassword" type="password" placeholder="변경하지 않으시면 비워두세요" />
        </div>
...
.field input:focus {
  outline: none; border-color: #6366f1; background: rgba(255, 255, 255, 0.1);
}
.field.disabled-field input { cursor: not-allowed; opacity: 0.6; }
.error-msg { color: #f87171; font-size: 0.85rem; font-weight: 500; }
...
.btn-submit:hover:not(:disabled) { background: #4f46e5; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(99, 102, 241, 0.3); }
