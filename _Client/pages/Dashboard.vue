...
import AiQueryViewer from "~/components/dashboard/AiQueryViewer.vue";
  ...
  <div v-if="userInfo" class="dashboard-page">
    ...
    <div class="dashboard-folder">
      <div class="dashboard-tabs" aria-label="대시보드 섹션">
        ...
        <button
          v-if="userInfo.role_id === 'A'"
          :class="{ active: activeTab === 'ai-query' }"
          :aria-pressed="activeTab === 'ai-query'"
          @click="setActiveTab('ai-query')">
          <IconCalendar class="tab-icon" /> AI 일반질의
        </button>
      </div>
      ...
      <div class="dashboard-content">
        ...
        <div v-else-if="activeTab === 'ai-query'">
          <AiQueryViewer />
        </div>
