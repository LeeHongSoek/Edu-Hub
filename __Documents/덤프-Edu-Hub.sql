...
--
-- Table structure for table `enm_logtype`
--

DROP TABLE IF EXISTS `enm_logtype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `enm_logtype` (
  `logtype_id` char(1) NOT NULL COMMENT '로그타입 코드 (Q, B, E : 문제,문재집,고사)',
  `description` varchar(50) NOT NULL COMMENT '로그타입 설명 (문제,문재집,고사)',
  PRIMARY KEY (`logtype_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='로그타입 기초 데이터';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `enm_logtype`
--

LOCK TABLES `enm_logtype` WRITE;
...
(5,5,5,'우리아이 주말 확인 점검 (학부모 생성)','2026-03-25 10:00:00','2026-03-25 11:00:00','자택 거실',1,NULL,'2026-03-27 21:48:29','N'),
...
(31,5,13,'패턴/자료구조 경시대회','2026-05-03 14:00:00','2026-05-03 15:30:00','제1 시험장',1,NULL,'2026-03-27 21:48:29','N'),
...
(40,5,21,'HTML/CSS 데일리 퀴즈','2026-05-22 17:00:00','2026-05-22 17:40:00','제3 시험장',1,NULL,'2026-03-27 21:48:29','N'),
...
(49,5,8,'마지막 정리 합동 세션','2026-06-09 18:00:00','2026-06-09 19:30:00','제3 시험장',1,NULL,'2026-03-27 21:48:29','N'),
(50,6,9,'5월 마무리 종합','2026-06-11 10:00:00','2026-06-11 11:30:00','제1 시험장',1,NULL,'2026-03-27 21:48:29','N'),
(51,7,10,'집중 대비 새벽 스터디','2026-06-13 05:30:00','2026-06-13 07:00:00','자택',1,NULL,'2026-03-27 21:48:29','N'),
(52,8,11,'기말 직전 모의고사','2026-06-15 13:00:00','2026-06-15 15:00:00','제3 시험장',1,NULL,'2026-03-27 21:48:29','N'),
(53,1,12,'특강+테스트 복합','2026-06-17 18:00:00','2026-06-17 19:30:00','온라인',1,NULL,'2026-03-27 21:48:29','N'),
(54,2,13,'부모님과 함께하는 설명회','2026-06-19 10:00:00','2026-06-19 11:30:00','자택',1,NULL,'2026-03-27 21:48:29','N'),
(55,3,14,'문제해결 실전 모의','2026-06-21 14:00:00','2026-06-21 15:30:00','제1 시험장',1,NULL,'2026-03-27 21:48:29','N'),
...
DROP TABLE IF EXISTS `questionbooks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `questionbooks` (
...
--
-- Dumping data for table `questionbooks`
--
...
(4,4,'김철수 단원별 정리: 알고리즘Ⅰ','기본 알고리즘 개념을 요약한 문제집','2026-03-27 21:48:29','N'),
(5,5,'김철수 단원별 정리: 알고리즘Ⅱ','응용 알고리즘과 손코딩 문제로 구성된 컬렉션','2026-03-27 21:48:29','N'),
(6,6,'김철수 통계 마스터십','평균, 분산, 확률까지 차근차근 복습하는 문제집','2026-03-27 21:48:29','N'),
(7,7,'김철수 프론트엔드 스프린트','HTML/CSS/JavaScript 핵심 실습 문제 집중','2026-03-27 21:48:29','N'),
(8,8,'김철수 Python Quick Win','회고 와 퀵 윈을 위한 파이썬 문제 셋','2026-03-27 21:48:29','N'),
(9,1,'김철수 자료구조 이론 정리','스택, 큐, 그래프를 중심으로 이론을 정리','2026-03-27 21:48:29','N'),
(10,2,'김철수 기말 대비 영어','독해·어휘·문법을 섞어 만든 복습 문제집','2026-03-27 21:48:29','N'),
(11,3,'김철수 약점 분석 리뷰','최근 틀린 문제만 모아둔 집중 리뷰북','2026-03-27 21:48:29','N'),
(12,4,'김철수 오답 노트 - 3월','틀린 문제를 한번 더 되짚는 서술형 오답 노트','2026-03-27 21:48:29','N'),
(13,5,'김철수 운영체제 실전','프로세스, 스케줄링, 메모리 중심 문제','2026-03-27 21:48:29','N'),
(14,6,'김철수 네트워크 진도별','OSI 7계층부터 TCP/IP까지 점검','2026-03-27 21:48:29','N'),
(15,7,'김철수 MySQL 실습','SQL 작성 흐름과 디버깅에 집중한 복습','2026-03-27 21:48:29','N'),
(16,8,'김철수 컴퓨터 구조 리뷰','기계어, 캐시, 연산 등 기초 개념 정리','2026-03-27 21:48:29','N'),
(17,1,'김철수 AI 수학 믹스','행렬·확률·통계 기반 문제들을 적절히 섞은 믹스','2026-03-27 21:48:29','N'),
(18,2,'김철수 논술형 대비','서술형 답안 구조를 연습하는 문항 모음','2026-03-27 21:48:29','N'),
(19,3,'김철수 자료구조 속성 복습','선형 자료구조 성능 비교 중심 문제 세트','2026-03-27 21:48:29','N'),
(20,4,'김철수 프로젝트 리뷰 꾸러미','실습 중 자주 쓰는 문제들을 묶은 번외 세트','2026-03-27 21:48:29','N'),
(21,5,'학부모 시선: 우리아이 핵심 체크1','기초 체력 점검용 부모용 문제집','2026-03-27 21:48:29','N'),
(22,6,'학부모 시선: 우리아이 핵심 체크2','취약 영역별 요약 문제로 구성된 부모 협업북','2026-03-27 21:48:29','N'),
(23,7,'제이미 선생님 추천 문제집','교사용으로 만든 추천 문제 묶음','2026-03-27 21:48:29','N'),
(24,8,'김철수 Java 실전 클러스터','기초 자바 문법부터 스프링까지 통합','2026-03-27 21:48:29','N'),
(25,1,'김철수 알고리즘 파이널','대회형 알고리즘 문제를 정리한 실전집','2026-03-27 21:48:29','N'),
(26,2,'김철수 스킬업 SQL','한 번에 흐름을 읽는 SQL 집중 훈련','2026-03-27 21:48:29','N'),
(27,3,'김철수 클라우드 네트워크','클라우드 네트워크 구성 중심 실습 문제','2026-03-27 21:48:29','N'),
(28,4,'김철수 자료 구조 집중코스','트리부터 힙까지 확장 문제를 묶은 세트','2026-03-27 21:48:29','N'),
(29,5,'김철수 프로그래밍 챌린지','자체 문제 50문제를 한 번에 푸는 연습','2026-03-27 21:48:29','N'),
(30,6,'김철수 경시대비 리뷰','시간 제한 기반 경시형 문제 모음','2026-03-27 21:48:29','N'),
(31,7,'김철수 TOEIC+코딩','영어 독해와 코딩 논리를 섞은 셋','2026-03-27 21:48:29','N'),
(32,8,'김철수 파이썬 디버깅','에러로그 해석과 디버깅을 묶은 문제집','2026-03-27 21:48:29','N'),
(33,1,'김철수 개발자 인터뷰 예제','자주 묻는 개념 문항을 정리','2026-03-27 21:48:29','N'),
(34,2,'김철수 네트워크 운영실','네트워크 구조와 운영 시나리오 문제집','2026-03-27 21:48:29','N'),
(35,3,'김철수 컴퓨터 시스템 그림책','도표 중심 하드웨어 설명 문제','2026-03-27 21:48:29','N'),
(36,4,'김철수 데이터 분석 실습','통계와 시각화 질문이 섞인 문제집','2026-03-27 21:48:29','N'),
(37,5,'김철수 컬러 코딩 일지','한 문항씩 색으로 인지하는 개념 정리','2026-03-27 21:48:29','N'),
(38,6,'김철수 통합 모의고사','실제 시험질문과 같은 형식으로 구성','2026-03-27 21:48:29','N'),
(39,7,'김철수 소프트웨어 정책 리뷰','운영 정책과 윤리 문제를 묶은 세트','2026-03-27 21:48:29','N'),
(40,8,'김철수 AI/ML 실전','머신러닝 원리 기반 문제집','2026-03-27 21:48:29','N'),
(41,1,'김철수 과학 리콜','물리/화학 통합 문제로 구성된 리뷰','2026-03-27 21:48:29','N'),
(42,2,'김철수 실무 배포 연습','CI/CD와 데브옵스 상황문제','2026-03-27 21:48:29','N'),
(43,3,'김철수 집중 리팩터링','코드 품질과 리팩터링 중심 질문','2026-03-27 21:48:29','N'),
(44,4,'김철수 JavaScript 심화','노드 · 브라우저 경계를 넘나드는 실습','2026-03-27 21:48:29','N'),
(45,5,'김철수 디자인 패턴 리서치','패턴별 핵심 개념을 뽑은 미션셋','2026-03-27 21:48:29','N'),
(46,6,'김철수 게임 개발 집중','시뮬레이션 캡슐화 · 이벤트 문제 세트','2026-03-27 21:48:29','N'),
(47,7,'김철수 OS+네트워크 리뷰','운영체제와 네트워크 실습을 잇는 문항','2026-03-27 21:48:29','N'),
(48,8,'김철수 데이터 시각화','차트·SQL 결과를 엮은 분석 문제','2026-03-27 21:48:29','N'),
(49,1,'김철수 AI 수학 연계','확률·선형대수를 응용하는 해법 질문','2026-03-27 21:48:29','N'),
(50,2,'김철수 실전 PT 리허설','서술/객관식 혼합형 실전 리허설','2026-03-27 21:48:29','N'),
(51,3,'김철수 국제 공모전 준비','프로그래밍·논술 혼합 셋','2026-03-27 21:48:29','N'),
(52,4,'김철수 스타트업 팀워크','협업 시나리오와 이슈 대응 문항','2026-03-27 21:48:29','N'),
(53,5,'김철수 에디터 픽셀','UI 설계 · 디버그 사례 중심','2026-03-27 21:48:29','N'),
(57,1,'오늘의 공개문제 풀이문제집','오늘의 공개문제 풀이문제집','2026-03-27 21:48:29','N'),
(58,1,'오늘의 공개문제','매일 자동으로 갱신되는 추천 문제 세트입니다.','2026-04-02 11:10:37','N');
/*!40000 ALTER TABLE `questionbooks` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `questions` (
  ...
  `p_question_id` bigint(20) DEFAULT NULL COMMENT '부모 문제 고유 식별자 (외래키)',
  `creator_no` bigint(20) NOT NULL COMMENT '생성자(선생님/학생) 식별번호',
  `group_id` bigint(20) DEFAULT NULL COMMENT '문제 소속 그룹 ID (외래키)',
  `question_type_id` char(1) NOT NULL DEFAULT 'N' COMMENT '문제 유형 코드 (enm_question_types 참조)',
  ...
  `is_public` tinyint(1) DEFAULT 1 COMMENT '공유 활성화 여부 (0:비공개, 1:공개)',
