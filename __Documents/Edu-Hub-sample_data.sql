...
(1,1,20,'M','HTML - 시맨틱 태그 (5지선다)','다음 중 HTML 시맨틱 태그의 역할로 가장 알맞은 것은?','문서 구조를 의미 있게 구분하는 태그의 목적을 묻는 문제입니다.','3','시맨틱 태그는 문서의 의미를 명확히 해 접근성과 유지보수성을 높입니다.','구조와 의미를 떠올려 보세요.',2,1,'N',60,1,'2026-03-27 21:48:28'),
...
(8,8,4,'M','HTML 시맨틱 태그','다음 중 HTML 시맨틱 태그의 역할로 가장 알맞은 것은?','문서의 구조와 의미를 분리해 표현하는 개념을 묻는 문제입니다.','1','시맨틱 태그는 문서 구조를 명확히 해 접근성과 유지보수성을 높입니다.','태그가 무엇을 뜻하는지 생각해 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(9,1,5,'M','CSS 박스 모델','다음 중 CSS 박스 모델에서 margin이 의미하는 것은?','요소 주변의 여백 개념을 확인하는 기본 개념 문제입니다.','2','margin은 요소 바깥쪽 공간을 뜻하고, 요소 간 간격을 만드는 데 쓰입니다.','요소 밖의 공간인지, 안쪽의 공간인지 구분해 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(10,2,6,'M','JavaScript 배열 메서드','다음 중 원본 배열을 직접 변경하는 JavaScript 메서드는?','배열 메서드가 원본을 바꾸는지 여부를 묻는 문제입니다.','3','splice는 원본 배열을 수정하고, slice나 map은 새 배열을 반환합니다.','원본 배열을 바꾸는 메서드를 떠올려 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(11,3,4,'M','Python 리스트 컴프리헨션','다음 중 Python 리스트 컴프리헨션의 특징으로 가장 알맞은 것은?','반복문과 조건식을 한 줄로 압축하는 문법을 확인합니다.','4','리스트 컴프리헨션은 새 리스트를 간결하게 생성할 수 있게 해 줍니다.','반복과 조건을 한 줄로 표현할 수 있는지 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(12,4,5,'M','Git merge와 rebase','다음 중 Git rebase에 대한 설명으로 가장 알맞은 것은?','브랜치 기록을 정리하는 방식을 확인하는 문제입니다.','1','rebase는 커밋을 다른 기준점 위로 옮겨 히스토리를 정리하는 데 자주 쓰입니다.','기준 커밋을 다시 쌓는다는 느낌으로 생각해 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(13,5,6,'M','SQL 인덱스','다음 중 SQL 인덱스의 일반적인 역할로 가장 알맞은 것은?','조회 성능과 저장 구조의 관계를 묻는 문제입니다.','2','인덱스는 검색 속도를 높이는 대신 저장 공간과 쓰기 비용이 늘 수 있습니다.','조회는 빨라지지만 모든 작업이 좋아지는 것은 아닙니다.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(14,6,4,'M','HTTP 상태 코드','다음 중 HTTP 404 상태 코드의 의미로 가장 알맞은 것은?','웹 요청 결과를 해석하는 기본 상태 코드 문제입니다.','3','404는 요청한 리소스를 서버에서 찾을 수 없을 때 사용됩니다.','존재하지 않는 페이지를 떠올려 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(15,7,5,'M','프로세스와 스레드','다음 중 스레드에 대한 설명으로 가장 알맞은 것은?','운영체제의 실행 단위 차이를 확인하는 문제입니다.','4','스레드는 프로세스 내부에서 실행되는 흐름 단위로, 자원을 공유하며 동작합니다.','프로세스 내부의 실행 흐름인지 생각해 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(16,8,6,'M','TCP와 UDP','다음 중 UDP의 특징으로 가장 알맞은 것은?','전송 계층 프로토콜의 성질을 비교하는 문제입니다.','1','UDP는 연결 설정이 없고 오버헤드가 적어 빠르지만 신뢰성 보장은 상대적으로 약합니다.','연결 절차가 간단한지 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(17,1,4,'M','스택과 큐','다음 중 큐(Queue)의 자료구조 특징으로 가장 알맞은 것은?','선입선출 개념을 확인하는 기본 자료구조 문제입니다.','2','큐는 먼저 들어온 데이터가 먼저 나가는 FIFO 구조입니다.','대기 줄을 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(18,2,5,'M','시간 복잡도','다음 중 빅오 표기법 O(n) 의 의미로 가장 알맞은 것은?','입력 크기에 따른 증가 양상을 묻는 문제입니다.','3','O(n)은 입력 크기에 비례해 처리 시간이 증가하는 형태를 말합니다.','입력이 두 배면 수행량도 대체로 두 배인지 생각해 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(19,3,6,'M','정규화','다음 중 데이터베이스 정규화의 주된 목적은?','중복과 이상 현상을 줄이는 설계 개념을 묻습니다.','4','정규화는 데이터 중복을 줄이고 삽입/갱신/삭제 이상을 완화하는 데 목적이 있습니다.','중복을 줄이고 일관성을 높이는 방향을 떠올려 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(20,4,4,'M','REST API','다음 중 REST API 설계 원칙에 가장 가까운 것은?','리소스 중심 설계와 HTTP 메서드 사용을 확인합니다.','1','REST는 리소스를 URI로 표현하고 HTTP 메서드로 행위를 구분하는 방식입니다.','리소스를 중심으로 생각해 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(21,5,5,'M','인증과 인가','다음 중 인가(Authorization)에 대한 설명으로 가장 알맞은 것은?','로그인 이후 권한 판단의 의미를 구분하는 문제입니다.','2','인가는 사용자가 어떤 자원에 접근할 수 있는지 권한을 확인하는 과정입니다.','“무엇을 할 수 있는가”를 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(22,6,6,'M','React props와 state','다음 중 React state의 특징으로 가장 알맞은 것은?','컴포넌트 내부 상태와 외부 입력을 구분하는 문제입니다.','3','state는 컴포넌트 내부에서 관리되는 값이며, 변화에 따라 화면이 다시 렌더링될 수 있습니다.','컴포넌트 내부에서 바뀌는 값인지 생각해 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(23,7,4,'M','async와 await','다음 중 JavaScript의 await 키워드 설명으로 가장 알맞은 것은?','비동기 함수의 흐름 제어를 묻는 문제입니다.','4','await는 Promise가 처리될 때까지 현재 async 함수의 실행을 잠시 멈춘 것처럼 보이게 합니다.','Promise 결과를 기다린다고 생각해 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(24,8,5,'M','정규식','다음 중 정규식에서 \+ 의 일반적인 의미로 가장 알맞은 것은?','반복 패턴 표현의 기본 문법을 확인합니다.','1','+는 바로 앞 패턴이 1회 이상 반복됨을 뜻합니다.','한 번 이상 반복인지 떠올려 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(25,1,6,'M','UTF-8 인코딩','다음 중 UTF-8의 특징으로 가장 알맞은 것은?','문자 인코딩 방식의 기본 성질을 묻는 문제입니다.','2','UTF-8은 가변 길이 인코딩이며 ASCII와 호환성을 가집니다.','문자마다 바이트 수가 달라질 수 있는지 생각해 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(26,2,4,'M','Factory Method 패턴','다음 중 Factory Method 패턴의 의도로 가장 알맞은 것은?','객체 생성 책임을 분리하는 디자인 패턴 문제입니다.','3','Factory Method는 객체 생성을 서브클래스나 별도 메서드에 위임해 유연성을 높입니다.','생성 코드를 한 곳에 고정하지 않는다고 생각해 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(27,3,5,'M','상속과 합성','다음 중 합성(composition)에 대한 설명으로 가장 알맞은 것은?','객체 간 관계를 설계할 때의 선택을 묻는 문제입니다.','4','합성은 객체를 포함 관계로 조합하는 방식으로, 상속보다 유연할 수 있습니다.','“is-a”보다 “has-a” 관계를 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(28,4,6,'M','단위 테스트와 통합 테스트','다음 중 단위 테스트의 일반적인 특징으로 가장 알맞은 것은?','테스트 범위의 크기를 구분하는 문제입니다.','1','단위 테스트는 작은 기능 단위를 독립적으로 검증하는 테스트입니다.','작고 독립적인 범위를 떠올려 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(29,5,4,'M','리눅스 권한','다음 중 Linux 파일 권한의 세 그룹으로 가장 알맞은 것은?','소유자와 그룹, 기타 사용자 권한 구분을 묻는 문제입니다.','2','권한은 보통 소유자(owner), 그룹(group), 기타(other)로 나눠 관리합니다.','3개 묶음으로 생각해 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(30,6,5,'M','브랜치 전략','다음 중 Git 브랜치 전략의 일반적인 목적은?','협업 시 코드 변경을 분리하고 관리하는 방식을 묻습니다.','3','브랜치 전략은 작업을 분리하고 충돌을 줄이며 협업 흐름을 관리하는 데 도움이 됩니다.','작업을 나눠 병합하기 쉽게 만든다고 생각해 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(31,7,6,'M','JSON과 XML','다음 중 JSON의 일반적인 특징으로 가장 알맞은 것은?','데이터 교환 포맷의 구조 차이를 확인하는 문제입니다.','4','JSON은 가볍고 사람이 읽기 쉬운 구조로 API 응답에 자주 쓰입니다.','중괄호와 대괄호를 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(32,8,4,'M','Flexbox 정렬','다음 중 Flexbox의 justify-content 속성이 주로 다루는 것은?','플렉스 컨테이너의 주축 정렬을 묻는 문제입니다.','1','justify-content는 주축 방향으로 아이템을 어떻게 배치할지 정합니다.','주축 방향 정렬인지 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(33,1,5,'M','DOM 이벤트 버블링','다음 중 DOM 이벤트 버블링에 대한 설명으로 가장 알맞은 것은?','이벤트가 상위 요소로 전파되는 흐름을 묻는 문제입니다.','2','버블링은 이벤트가 발생한 요소에서 상위 요소 방향으로 전파되는 현상입니다.','안쪽에서 바깥쪽으로 올라간다고 생각해 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(34,2,6,'M','localStorage와 sessionStorage','다음 중 sessionStorage의 특징으로 가장 알맞은 것은?','브라우저 저장소의 지속 범위를 비교하는 문제입니다.','3','sessionStorage는 세션 단위로 유지되며 탭을 닫으면 일반적으로 사라집니다.','탭이나 세션이 끝날 때를 떠올려 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(35,3,4,'M','인덱스 스캔과 시크','다음 중 index seek의 일반적인 의미로 가장 알맞은 것은?','DB 조회 계획에서 인덱스를 활용하는 방식을 묻습니다.','4','seek는 인덱스를 이용해 필요한 위치를 빠르게 찾는 동작을 뜻합니다.','인덱스로 목표 위치를 바로 찾는다고 생각해 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(36,4,5,'M','캡슐화','다음 중 객체지향에서 캡슐화의 목적에 가장 가까운 것은?','정보 은닉과 인터페이스 분리를 확인하는 문제입니다.','1','캡슐화는 내부 구현을 숨기고 필요한 기능만 외부에 제공하는 개념입니다.','내부를 감추고 외부에는 사용법만 보여준다고 생각해 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(37,5,6,'M','INNER JOIN과 LEFT JOIN','다음 중 LEFT JOIN의 일반적인 특징으로 가장 알맞은 것은?','조인 방식에 따라 결과 집합이 달라지는지 묻는 문제입니다.','2','LEFT JOIN은 왼쪽 테이블의 행을 모두 유지하고 오른쪽이 없으면 NULL을 채울 수 있습니다.','왼쪽 기준으로 결과가 남는지 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(38,6,4,'M','TLS와 HTTPS','다음 중 HTTPS가 제공하는 대표적인 이점으로 가장 알맞은 것은?','웹 통신 보안의 기본 목적을 묻는 문제입니다.','3','HTTPS는 TLS를 이용해 전송 구간의 암호화와 무결성 보호에 도움을 줍니다.','전송 중 도청과 변조를 줄이는 기능을 떠올려 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(39,7,5,'M','기본 키와 유니크','다음 중 primary key의 일반적인 특징으로 가장 알맞은 것은?','식별자 제약의 의미를 구분하는 문제입니다.','4','기본 키는 레코드를 고유하게 식별하며 NULL을 허용하지 않는 경우가 일반적입니다.','행을 유일하게 구분하는 값인지 생각해 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(40,8,6,'M','Debounce와 Throttle','다음 중 debounce의 일반적인 동작으로 가장 알맞은 것은?','연속 이벤트 처리 타이밍을 제어하는 기법을 묻습니다.','1','debounce는 이벤트가 잠시 멈춘 뒤 마지막 동작만 실행하는 데 적합합니다.','멈춘 뒤 한 번 실행하는 느낌을 떠올려 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(41,1,4,'M','Stable Sort','다음 중 안정 정렬(stable sort)의 의미로 가장 알맞은 것은?','같은 키를 가진 원소의 상대적 순서를 보존하는지 묻는 문제입니다.','2','안정 정렬은 키 값이 같은 원소들의 기존 순서를 유지합니다.','같은 값의 순서가 유지되는지 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(42,2,5,'M','MVC와 MVVM','다음 중 MVVM 패턴의 핵심 요소로 가장 알맞은 것은?','UI와 데이터 바인딩 구조를 비교하는 문제입니다.','3','MVVM은 View와 ViewModel을 통해 화면 상태와 로직을 분리하는 패턴입니다.','화면과 상태를 연결하는 중간 계층을 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(43,3,6,'M','해시 충돌','다음 중 해시 충돌(collision)의 의미로 가장 알맞은 것은?','해시 함수의 한계를 이해하는 기본 개념 문제입니다.','4','서로 다른 입력이 같은 해시 값으로 매핑되는 상황을 충돌이라고 합니다.','서로 다른 값이 같은 해시를 만드는 상황입니다.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(44,4,4,'M','API 페이지네이션','다음 중 페이지네이션의 일반적인 목적은?','대량 데이터를 나누어 전달하는 목적을 묻습니다.','1','페이지네이션은 한 번에 많은 데이터를 보내지 않고 나눠서 전달해 응답 부담을 줄입니다.','목록을 여러 페이지로 나눠 보여준다고 생각해 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(45,5,5,'M','CSS position','다음 중 position: absolute 의 일반적인 특징으로 가장 알맞은 것은?','CSS 배치 방식의 기준 요소를 묻는 문제입니다.','2','absolute는 가장 가까운 위치 지정 조상 요소를 기준으로 배치될 수 있습니다.','기준이 되는 부모를 떠올려 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(46,6,6,'M','배열과 연결 리스트','다음 중 연결 리스트의 일반적인 장점으로 가장 알맞은 것은?','자료 구조의 삽입/삭제 특성을 비교하는 문제입니다.','3','연결 리스트는 노드 연결을 조정해 중간 삽입/삭제에 유리할 수 있습니다.','중간에 끼워 넣는 작업을 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(47,7,4,'M','스택 오버플로와 힙 오버플로','다음 중 스택 오버플로의 일반적인 원인으로 가장 알맞은 것은?','재귀 호출과 스택 메모리 한계를 확인하는 문제입니다.','4','재귀가 너무 깊어지면 스택 공간이 부족해질 수 있습니다.','재귀 호출이 과도해질 때를 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(48,8,5,'M','이진 탐색 트리','다음 중 이진 탐색 트리(BST)의 기본 규칙으로 가장 알맞은 것은?','왼쪽과 오른쪽 서브트리의 값 관계를 묻는 문제입니다.','1','BST는 왼쪽 서브트리에는 작은 값, 오른쪽 서브트리에는 큰 값이 오도록 유지합니다.','왼쪽은 작고 오른쪽은 큰 규칙을 생각해 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(49,1,6,'M','컴파일러와 인터프리터','다음 중 인터프리터 방식의 일반적인 설명으로 가장 알맞은 것은?','실행 방식 차이를 이해하는 기본 개념 문제입니다.','2','인터프리터는 소스 코드를 한 줄씩 해석하며 실행하는 방식으로 설명할 수 있습니다.','해석하면서 바로 실행하는 흐름을 떠올려 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(50,2,4,'M','메모리 누수와 OOM','다음 중 메모리 누수(memory leak)의 일반적인 설명으로 가장 알맞은 것은?','반복 실행 중 메모리 해제가 제대로 되지 않는 상황을 묻습니다.','3','메모리 누수는 더 이상 필요 없는 메모리를 해제하지 못해 누적되는 현상입니다.','사용하지 않는 메모리가 계속 남는 상황을 떠올려 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(51,3,5,'M','Cookies와 Session','다음 중 Cookie의 일반적인 특징으로 가장 알맞은 것은?','웹 상태 유지 방식의 차이를 묻는 문제입니다.','4','쿠키는 브라우저에 저장되며 만료 시간과 속성 설정을 가질 수 있습니다.','브라우저에 저장되는 작은 정보 조각을 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(52,4,6,'M','CSRF와 XSS','다음 중 XSS 공격의 일반적인 설명으로 가장 알맞은 것은?','웹 보안 공격 유형을 구분하는 문제입니다.','1','XSS는 악성 스크립트를 삽입해 다른 사용자의 브라우저에서 실행되게 하는 공격입니다.','스크립트가 브라우저에서 실행되는지 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
(53,5,4,'M','오버로딩과 오버라이딩','다음 중 오버라이딩(overriding)의 설명으로 가장 알맞은 것은?','같은 이름의 메서드를 재정의하는 개념을 묻습니다.','2','오버라이딩은 상속받은 메서드를 하위 클래스에서 다시 정의하는 것입니다.','부모 메서드를 자식이 다시 작성하는지 생각해 보세요.',1,1,'N',60,0,'2026-03-27 21:48:28'),
(54,6,5,'M','제3정규형(3NF)','다음 중 제3정규형(3NF)의 일반적인 목적은?','함수 종속성과 데이터 중복을 줄이는 설계 원칙을 묻습니다.','3','3NF는 이행적 종속을 제거해 데이터 중복과 이상 현상을 줄이는 데 도움이 됩니다.','기본 키가 아닌 컬럼 간 종속을 떠올려 보세요.',2,1,'N',90,0,'2026-03-27 21:48:28'),
(55,7,6,'M','ACID 속성','다음 중 데이터베이스 ACID의 A가 의미하는 것은?','트랜잭션의 기본 성질을 묻는 문제입니다.','4','A는 Atomicity로, 트랜잭션이 전부 성공하거나 전부 실패하는 원자성을 뜻합니다.','전부 아니면 전무의 개념을 떠올려 보세요.',3,1,'N',120,0,'2026-03-27 21:48:28'),
(56,8,4,'M','CDN','다음 중 CDN의 일반적인 역할로 가장 알맞은 것은?','콘텐츠 전송 최적화 개념을 확인하는 문제입니다.','1','CDN은 여러 지역의 캐시 서버를 통해 콘텐츠 전달 속도와 안정성을 높이는 데 도움을 줍니다.','가까운 서버에서 콘텐츠를 받는 구조를 떠올려 보세요.',4,1,'N',150,0,'2026-03-27 21:48:28'),
(57,1,5,'M','BFS와 DFS','다음 중 BFS의 일반적인 탐색 방식으로 가장 알맞은 것은?','그래프 탐색 순서를 구분하는 문제입니다.','2','BFS는 시작 정점에서 가까운 정점부터 넓게 탐색하는 방식입니다.','너비 우선 탐색이라는 이름을 떠올려 보세요.',5,1,'N',180,0,'2026-03-27 21:48:28'),
...
-- Groups seed (generated)
INSERT INTO `groups` (group_id, creator_no, parent_group_id, depth, name, description) VALUES
  (24, 1, NULL, 1, '수학', '수학 전반 분류'),
  (25, 2, NULL, 1, '영어', '영어 전반 분류'),
  (26, 3, NULL, 1, '과학', '과학 전반 분류'),
  (27, 4, NULL, 1, '사회', '사회 전반 분류'),
  (28, 5, NULL, 1, '코딩', '코딩 전반 분류'),
  (29, 6, NULL, 1, '데이터', '데이터 전반 분류'),
  (30, 7, NULL, 1, '국어', '국어 전반 분류'),
  (31, 8, NULL, 1, '역사', '역사 전반 분류'),
  (32, 9, NULL, 1, '경제', '경제 전반 분류'),
  (33, 10, NULL, 1, '예체능', '예체능 전반 분류'),
  (34, 11, 24, 2, '대수', '수학 > 대수 세부 주제'),
  (35, 12, 24, 2, '기하', '수학 > 기하 세부 주제'),
  (36, 13, 25, 2, '문법', '영어 > 문법 세부 주제'),
  (37, 14, 25, 2, '독해', '영어 > 독해 세부 주제'),
  (38, 15, 26, 2, '물리', '과학 > 물리 세부 주제'),
  (39, 16, 26, 2, '화학', '과학 > 화학 세부 주제'),
  (40, 17, 27, 2, '지리', '사회 > 지리 세부 주제'),
  (41, 18, 27, 2, '윤리', '사회 > 윤리 세부 주제'),
  (42, 19, 28, 2, '알고리즘', '코딩 > 알고리즘 세부 주제'),
  (43, 20, 28, 2, '웹개발', '코딩 > 웹개발 세부 주제'),
  (44, 21, 29, 2, '통계', '데이터 > 통계 세부 주제'),
  (45, 22, 29, 2, '머신러닝', '데이터 > 머신러닝 세부 주제'),
  (46, 23, 30, 2, '문학', '국어 > 문학 세부 주제'),
  (47, 24, 30, 2, '비문학', '국어 > 비문학 세부 주제'),
  (48, 25, 31, 2, '한국사', '역사 > 한국사 세부 주제'),
  (49, 1, 31, 2, '세계사', '역사 > 세계사 세부 주제'),
  (50, 2, 32, 2, '미시경제', '경제 > 미시경제 세부 주제'),
  (51, 3, 32, 2, '거시경제', '경제 > 거시경제 세부 주제'),
  (52, 4, 33, 2, '미술', '예체능 > 미술 세부 주제'),
  (53, 5, 33, 2, '음악', '예체능 > 음악 세부 주제');
